...
//? get category by id  localhost/category/:categoryId
router.get('/:categoryId', expressAsyncHandler(categoryController.getCategoryById))
//? get all subcategories localhost/category/:categoryId
router.get('/:categoryId', expressAsyncHandler(categoryController.getAllSubCategories))
